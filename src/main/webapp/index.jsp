...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Myntra Summer Sale — Premium Picks</h1>
                <p>BLACK DOOMS Friday sale for clothing and accessories — curated just for you. Enjoy limited-time deals and free shipping on selected items.</p>
                <div>
